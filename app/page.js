  ...
  return (
    <main className="bg-white h-full flex flex-col overflow-hidden relative">
      ...
      <div className="flex-1 flex flex-col justify-center items-center w-full gap-3">
        <h4 className="font-bold text-xl text-gray z-[100]">Learn Banglish</h4>
        <h1 className="text-clamp font-bold text-center z-[100]">
          Thikmoto Text <br /> Korte Sikho
        </h1>
        <button className="new-sm:mt-[10rem]  new-sm:absolute new-sm:bottom-8 flex gap-[10px] items-center border-4 new-sm:border-3 border-black rounded-[50px] py-[10px] px-[30px] z-[100] ">
